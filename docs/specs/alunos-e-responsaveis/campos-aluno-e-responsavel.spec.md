...
Mantém o monólito: tipo de parentesco, financeiro para **este** aluno, ordem, fonte de endereço “mora com…” quando aplicável (`docs/specs/matricula/matricula-campos-edicoes-pos-ativa.spec.md` §4).
