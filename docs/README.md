...
- **Secretariat help chat (RAG):** answers “how do I…?” questions using a small set of versioned manuals (see `docs/specs/ia/chat-ajuda-rag.spec.md`); optional later: RAG over per-student enrollment documents
...
- `docs/politica-de-idiomas.md` — PT + EN: what “real i18n” means, canonical language, `docs/en/`
